...
const ProjectInfo = [
  {id: 0, image: VueIcon, flipped: false, gitLink:'https://gitlab.com/virgilavram.dev/ritekit-task',
  ...
  {id: 1, image: ReactIcon, flipped: false, gitLink:'https://github.com/virgilseo/neighborhood-map',
  ...
  {id: 2, image: VueIcon, flipped: false, gitLink:'https://github.com/virgilseo/circuly-task',
   liveLink: 'https://github.com/virgilseo/circuly-task', title:'Client address book' ,
   tag:'Add and access your clients addresses with ease',
   description:['Vue.js', 'JavaScript', 'Css', 'Html', 'Responsive Design', 'Rest api'] },
  {id: 3, image: ReactIcon, flipped: false, gitLink:'https://github.com/virgilseo/myreads',
  ...
  {id: 4, image: ResponsiveIcon, flipped: false, gitLink:'https://github.com/virgilseo/-mws-restaurant-reviews',
  ...
  {id: 5, image: JsIcon, flipped: false, gitLink:'https://github.com/virgilseo/arcade-game-clone-project',
  ...
  {id: 6, image: TddIcon, flipped: false, gitLink:'https://github.com/virgilseo/feedreader-project',
   liveLink: 'https://github.com/virgilseo/feedreader-project', title:'Feed Reader' ,tag:'Simple app that reads RSS feeds',
   description:['JavaScript', 'Css', 'Html', 'Jasmine.js', 'Test Driven Development'] },
  {id: 7, image: CssIcon, flipped: false, gitLink:'https://github.com/virgilseo/project-memory-game',
